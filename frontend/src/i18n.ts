...
const resources = {
  en: {
    translation: {
      ...
      metadataTitle: 'Additional tenant information',
      metadataTenantRegion: 'Tenant Region',
      metadataCloudType: 'Cloud Type',
    },
  },
  de: {
    translation: {
      ...
      actionExportHistory: 'Exportieren',
      copied: 'Kopiert',
      ...
      metadataTitle: 'Zusätzliche Tenant-Informationen',
      metadataTenantRegion: 'Tenant-Region',
      metadataCloudType: 'Cloud-Typ',
    },
  },
} as const
